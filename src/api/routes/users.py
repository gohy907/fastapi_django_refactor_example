...
@router.get(
    "/login/{login}", status_code=status.HTTP_200_OK, response_model=UserResponse
)
...
@router.get("/id/{id}", status_code=status.HTTP_200_OK, response_model=UserResponse)
...
@router.post(
    "/update/{id}", status_code=status.HTTP_200_OK, response_model=UserResponse
)
